...
class AddEditViewModel {
    ...
    func addPeople(name: String, sureName: String,imageName: String,dateOfBirth: String,dateOfDeath: String,description: String){
        db.insert(name: name, sureName: sureName, imageName: imageName, dateOfBirth: dateOfBirth, dateOfDeath: dateOfDeath, description: description, quotes: quotes)
    }
    ...
    func editPeople(id: String,name: String, sureName: String,imageName: String,dateOfBirth: String,dateOfDeath: String,description: String){
        db.edit(id: id, name: name, sureName: sureName, imageName: imageName, dateOfBirth: dateOfBirth, dateOfDeath: dateOfDeath, description: description,quotes: quotes)
    }
